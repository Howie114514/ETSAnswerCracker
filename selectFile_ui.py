...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"\u9009\u62e9\u8bb0\u5f55", None))
        self.label.setText(QCoreApplication.translate("Dialog", u"\u53cc\u51fb\u9009\u62e9", None))
    # retranslateUi
